...
//        mLinearWeek.setBackgroundColor(mDelegate.getWeekBackground());
        ...
        }); //end of " mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { "
        ...
        });  //end of "mSelectLayout.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {"
        ...
        };  //end of "mInnerListener = new OnInnerDateSelectedListener() {  "
...
//                        mSelectLayout.init(year);
    ...
    } //end of " private class CalendarViewPagerAdapter extends PagerAdapter {"
    ...
    }//end of "interface CalendarViewDelegate {"
}
